  ...
  <Spotlight
    ...
    <div className="p-4 relative z-10 w-full text-center">
        ...
        <p className="mt-4 font-normal text-base md:text-lg
         text-neutral-300 max-w-lg mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi dicta excepturi quod quas modi ullam numquam, deleniti ducimus, est nemo reprehenderit error molestias nihil maxime, iusto sit explicabo. Perspiciatis, quod!</p>
        <div className="mt-4">
            <Link href={"/courses"}>
            <Button
